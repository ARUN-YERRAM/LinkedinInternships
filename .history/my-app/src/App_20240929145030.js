...
/*************  ✨ Codeium Command ⭐  *************/
  /**
   * Load more products by incrementing the page number.
   *
   * The page number is used to fetch the next page of products from the server.
   * The page number is incremented by one and the products are refetched.
   */
/******  89fbfea8-db93-42b7-a1d1-d688def75cfe  *******/
  const loadMore = () => {
    setPage((prev) => prev + 1);
  };
